...
public class Fila {
	...
	public Pilha toPilha() {
		Pilha filaConvertida = new Pilha();

		for(CelulaFila i = primeiro.prox; i != null; i = i.prox){ 
			System.out.print(i.elemento + " capturado da fila e inserido na pilha!");
			filaConvertida.inserir(i.elemento); 
		}

		return filaConvertida;
	}

	public Pilha toOrdemInsercao(){
		Pilha filaInversa = new Pilha();
		toOrdemInsercao(filaInversa, primeiro);
		return filaInversa;
	}
}
