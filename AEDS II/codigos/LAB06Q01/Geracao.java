...
class Geracao {
	...
	public void aleatorio() {
		...
		crescente();	
		for (int i = 0; i < n; i++) { swap(i, Math.abs(rand.nextInt()) % n); }
	}
	...
	public void mostrar(int k) {
		...
		for (int i = 0; i < k; i++) { System.out.print(" ("+i+")" + array[i]); }
	...
	public void mostrar() {
		...
		for (int i = 0; i < n; i++) { System.out.print(" ("+i+")" + array[i]); }
	 ...
	 */
	public long now(){ return new Date().getTime(); }
